  ...
  /////////////////////////////////////////////////////////////
   ...
   /////////////////////////////////////////////////////////////////////////////////////////
	...
	if(ch=='3')
	{
		...
		gotoxy(27,8); printf("@  @  @ @  @@@@ @@@@ @@@ ");
		gotoxy(27,9); printf("--------------------------");
		gotoxy(20,13);printf("PLOT FOUR IS A TWO-PLAYER GAME IN WHICH ");
		gotoxy(20,14);printf("THE PLAYERS TAKE TURNS DROPPING COLORED ");
		gotoxy(20,15);printf("SMILIES FROM THE TOP INTO A GRID.       ");
		gotoxy(20,16);printf("THE PIECES FALL STRAIGHT DOWN,OCCUPYING ");
		gotoxy(20,17);printf("THE LOWEST SPACE WITHIN THE COLUMN.     ");
		gotoxy(20,18);printf("THE OBJECT OF THE GAME IS TO CONNECT FOUR");
		gotoxy(20,19);printf("OF ONE'S OWN SMILIES NEXT TO EACH OTHER ");
		gotoxy(20,20);printf("VERTICALLY,HORIZONTALLY,OR DIAGONALLY   ");
		gotoxy(20,21);printf("BEFORE YOUR OPPONENT.                   ");
		getch();
